...
public class ShaderChunkRendererMixin implements CustomizableShaderChunkRenderer
{
	...
	private void modifyShaderInterfaceFactory(Args args, String path, ChunkShaderOptions options)
	{
	...
	private ChunkFogMode modifyFogMode(ChunkFogMode fog)
	{
